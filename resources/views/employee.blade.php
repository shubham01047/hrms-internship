...
<body class="bg-gray-100 font-sans">
    ...
    <div class="fixed top-0 left-0 h-screen w-64 bg-red-700 text-white flex flex-col p-6">
        ...
        <a href="{{ url('/login') }}"
            class="mt-6 text-center border border-white rounded py-3 hover:bg-white hover:text-red-700 font-semibold transition">
    ...
    <div class="ml-64 p-6">
        ...
        <div class="mt-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button
                    class="w-full py-4 border border-blue-500 text-blue-500 rounded-lg font-semibold hover:bg-blue-500 hover:text-white transition">
                    <i class="bi bi-calendar-plus mr-2"></i> Apply Leave
                </button>
                <button
                    class="w-full py-4 border border-green-500 text-green-500 rounded-lg font-semibold hover:bg-green-500 hover:text-white transition">
                    <i class="bi bi-file-earmark-text mr-2"></i> View Payslips
                </button>
                <button
                    class="w-full py-4 border border-yellow-500 text-yellow-500 rounded-lg font-semibold hover:bg-yellow-500 hover:text-white transition">
