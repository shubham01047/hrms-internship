            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ count($holidays) }} holiday{{ count($holidays) !== 1 ? 's' : '' }} registered</p>
                    </div>
                </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200 {{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-25' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">{{ \Carbon\Carbon::parse($holiday->date)->format('M d, Y') }}</div>
                                            <div class="text-xs text-blue-600 font-medium">{{ \Carbon\Carbon::parse($holiday->date)->format('l') }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        $typeConfig = [
                                            'national' => ['bg' => 'bg-red-100', 'text' => 'text-red-800', 'emoji' => '🏛️'],
                                            'company' => ['bg' => 'bg-blue-100', 'text' => 'text-blue-800', 'emoji' => '🏢'],
                                            'festival' => ['bg' => 'bg-purple-100', 'text' => 'text-purple-800', 'emoji' => '🎉'],
                                            'event' => ['bg' => 'bg-green-100', 'text' => 'text-green-800', 'emoji' => '📅'],
                                        ];
                                        $config = $typeConfig[$holiday->type] ?? ['bg' => 'bg-gray-100', 'text' => 'text-gray-800', 'emoji' => '📋'];
                                    @endphp
