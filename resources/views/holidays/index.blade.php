<x-app-layout>
    ...
    <div class="bg-gradient-to-r from-blue-800 to-blue-900 px-6 py-8">
        <div class="flex items-center space-x-4 text-white">
            ...
            <div>
                <h1 class="text-3xl font-bold">Holiday Management</h1>
                <p class="text-blue-100 mt-1">Manage company holidays and special events</p>
            </div>
        </div>
    </div>
    ...
    @if (session('success'))
        <div class="mx-6 mt-6 bg-green-50 border-l-4 border-green-400 p-4">
            <div class="flex">
    ...
    @if (session('error'))
        <div class="mx-6 mt-6 bg-red-50 border-l-4 border-red-400 p-4">
            <div class="flex">
                <div class="flex-shrink-0">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-900">All Holidays</h2>
                            <p class="text-sm text-gray-600">{{ count($holidays) }} holidays registered</p>
                        </div>
                    </div>
                    @can('create holiday')
                                ...
                                <div class="col-span-2 flex items-center">
                                    @can('delete holiday')
                                        <form action="{{ route('holidays.destroy', $holiday->id) }}" method="POST" 
                                            ...
                                            @method('DELETE')
                                            <button type="submit" 
                                                    class="inline-flex items-center px-3 py-1 bg-red-100 hover:bg-red-200 text-red-700 text-sm font-medium rounded-full transition-colors">
