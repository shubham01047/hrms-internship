            ...
            <div class="theme-app flex justify-between items-center p-6 rounded-lg shadow-sm" style="background: linear-gradient(to right, var(--secondary-bg), var(--primary-bg));">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm" style="color: var(--secondary-text);">Create a new holiday entry for your organization</p>
                    </div>
                </div>
                    ...
                    <div class="theme-app px-6 py-4 border-b border-gray-200" style="background: linear-gradient(to right, var(--secondary-bg), var(--primary-bg));">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h2 class="text-xl font-bold" style="color: var(--primary-text);">Holiday Information</h2>
                                    <p class="text-sm" style="color: var(--secondary-text);">Fill in the details below to add a new holiday</p>
                                </div>
                            </div>
                        </div>
                    </div>
