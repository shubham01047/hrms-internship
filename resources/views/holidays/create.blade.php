                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    >
                                        <option value="" {{ old('type') == '' ? 'selected' : '' }}>Select Holiday Type</option>
                                        <option value="national" {{ old('type') == 'national' ? 'selected' : '' }}>🏛️ National Holiday</option>
                                        ...
                                        <option value="event" {{ old('type') == 'event' ? 'selected' : '' }}>📅 Special Event</option>
                                    </select>
                                    @error('type')
                                        <div class="flex items-center mt-2">
                                            <svg class="h-4 w-4 text-red-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    ...
                                    <div class="space-y-1 text-xs text-gray-600">
                                        <div class="flex items-center"><span class="w-4">🏛️</span> National - Government declared holidays</div>
                                        <div class="flex items-center"><span class="w-4">🏢</span> Company - Organization specific holidays</div>
                                        <div class="flex items-center"><span class="w-4">🎉</span> Festival - Religious or cultural celebrations</div>
                                        <div class="flex items-center"><span class="w-4">📅</span> Event - Special occasions or events</div>
                                    </div>
                                </div>
                            </div>
                        </div>
