        ...
        <div class="w-full max-w-3xl animate-fade-in animate-delay-200">
            <div class="form-container">
                <div class="form-header">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">Fill in the details to create a new task</p>
                </div>
                <div class="form-body">
                    <form method="POST" action="{{ route('projects.tasks.store', $project->id) }}" class="space-y-0">
                        @csrf
