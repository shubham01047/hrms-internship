        ...
        >
            <div class="flex items-center space-x-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xs sm:text-sm" style="color: var(--secondary-text);">Fill in the details to create a new task</p>
                </div>
            </div>
                ...
                <div class="theme-app px-4 sm:px-6 py-4 border-b border-gray-200" style="background: linear-gradient(to right, var(--secondary-bg), var(--primary-bg));">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm" style="color: var(--secondary-text);">Fill in the details to create a new task</p>
                        </div>
                    </div>
                </div>
