<x-app-layout>
    ...
    <div class="py-6 sm:py-8">
        <div class="max-w-6xl mx-auto px-2 sm:px-4 lg:px-6"> {{-- reduced side padding from px-4 sm:px-6 lg:px-8 --}}
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-200">
                ...
                <div class="p-3 sm:p-6"> {{-- reduced padding from p-4 sm:p-8 --}}
                    <form action="{{ route('users.store') }}" method="POST" class="space-y-4 sm:space-y-8">
                        @csrf
                        
                        {{-- User Information Section --}}
                        <div class="bg-gray-50 rounded-lg p-3 sm:p-5 border border-gray-200"> {{-- reduced padding from p-4 sm:p-6 --}}
                        ...
                        {{-- Password Section --}}
                        <div class="bg-green-50 rounded-lg p-3 sm:p-5 border border-green-200"> {{-- reduced padding from p-4 sm:p-6 --}}
                        ...
                        <div class="bg-blue-50 rounded-lg p-3 sm:p-5 border border-blue-200"> {{-- reduced padding from p-4 sm:p-6 --}}
                            <div class="flex items-center space-x-1.5 sm:space-x-2 mb-4 sm:mb-6">
