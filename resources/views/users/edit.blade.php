                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                <div class="space-y-2">
                                    ...
                                    <select name="gender"
                                        ...
                                        <option value="male"
                                            {{ old('gender', $users->gender) == 'male' ? 'selected' : '' }}>Male
                                        </option>
                                        <option value="female"
                                            {{ old('gender', $users->gender) == 'female' ? 'selected' : '' }}>Female
                                        </option>
                                        <option value="other"
                                            {{ old('gender', $users->gender) == 'other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                    <div id="gender-error"
                                        class="hidden flex items-center space-x-2 mt-2 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg">
                                ...
                                <div class="space-y-2 md:col-span-1">
                                    ...
                                    <input type="text" name="address"
                                        value="{{ old('address', $users->address) }}" placeholder="Street, Area"
                                        class="w-full px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white text-sm" />
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="date" name="joining_date"
                                        value="{{ old('joining_date', $users->joining_date) }}"
                                        class="w-full px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white text-sm" />
                                    <div id="joining_date-error"
                                        class="hidden flex items-center space-x-2 mt-2 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg">
                                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-500" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="employment_type" id="employment_type"
                                        ...
                                        <option value="Full-Time"
                                            {{ $users->employment_type == 'Full-Time' ? 'selected' : '' }}>Full-Time
                                        </option>
                                        <option value="Part-Time"
                                            {{ $users->employment_type == 'Part-Time' ? 'selected' : '' }}>Part-Time
                                        </option>
                                        <option value="intern"
                                            {{ $users->employment_type == 'intern' ? 'selected' : '' }}>Intern</option>
                                        <option value="trainee"
                                            {{ $users->employment_type == 'trainee' ? 'selected' : '' }}>Trainee
                                        </option>
                                        <option value="contract"
                                            {{ $users->employment_type == 'contract' ? 'selected' : '' }}>Contract
                                        </option>
                                    </select>
                                    <div id="employment_type-error"
                                        class="hidden flex items-center space-x-2 mt-2 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg">
                                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-500" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="terminated"
                                            {{ $users->status == 'terminated' ? 'selected' : '' }}>Terminated</option>
                                    </select>
                                    <div id="status-error"
                                        class="hidden flex items-center space-x-2 mt-2 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg">
                                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-500" fill="none"
                                ...
                                <div class="space-y-2 md:col-span-2">
                                    <label class="block text-sm font-semibold text-gray-700"
                                        for="resume">Resume</label>
                                    @if ($users->resume)
                                        <a href="{{ route('files.view', [
                                            'type' => 'resumes',
                                            'filename' => str_replace('uploads/resumes/', '', $users->resume),
                                        ]) }}"
                                            target="_blank" class="text-sm text-blue-600 underline">View Resume</a>
                                    @endif
                                ...
                                <div class="space-y-2 md:col-span-1">
                                    <label class="block text-sm font-semibold text-gray-700" for="aadhar_card">Aadhar
                                        Card</label>
                                    @if ($users->aadhar_card)
                                        <a href="{{ route('files.view', [
                                            'type' => 'aadhar',
                                            'filename' => str_replace('uploads/aadhar/', '', $users->aadhar_card),
                                        ]) }}"
                                            class="text-sm text-blue-600 underline" target="_blank">View
                                            Aadhar</a>
                                    @endif
                                    <input type="file" name="aadhar_card" id="aadhar_card"
                                        class="mt-2 w-full px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white text-sm" />
                                    <div id="aadhar_card-error"
                                        class="hidden flex items-center space-x-2 mt-2 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg">
                                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-500" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="space-y-2 md:col-span-1">
                                    <label class="block text-sm font-semibold text-gray-700" for="pan_card">PAN
                                        Card</label>
                                    @if ($users->pan_card)
                                        <a href="{{ route('files.view', [
                                            'type' => 'aadhar',
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="leave_balance"
                                        value="{{ old('leave_balance', $users->leave_balance) }}"
                                        class="w-full px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-4 focus:ring-blue-200 focus:border-blue-500 transition-all duration-300 bg-white text-sm" />
                                    <div id="leave_balance-error"
                                        class="hidden flex items-center space-x-2 mt-2 p-2 sm:p-3 bg-red-50 border border-red-200 rounded-lg">
                                        <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-red-500" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const validateContact = () => {
                ...
                if (!isDigits(digitsOnly)) return showError('contact_number',
            ...
            const validatePin = () => {
                ...
                if (v.length < 4 || v.length > 10) return showError('pin_code',
                    'PIN code must be 4 to 10 digits.');
            ...
            const validateSelectIn = (name, allowed, required = false, label = 'Selection') => {
                ...
                if (!isEmpty(v) && !allowed.includes(v)) return showError(name,
                    `Invalid ${label.toLowerCase()} selected.`);
                return showError(name, '');
            };
            ...
            const validateNumberNonNegative = (name, label = 'Value') => {
                ...
                if (isEmpty(v)) return showError(name, '');
                const num = Number(v);
                if (!Number.isFinite(num) || num < 0) return showError(name,
            ...
            const bindLiveValidation = () => {
                const map = [
                    ...
                    ['employment_type', () => validateSelectIn('employment_type', ['Full-Time', 'Part-Time',
                        'intern', 'trainee', 'contract'
                    ], false, 'Employment type'), ['change', 'blur']],
                    ['status', () => validateSelectIn('status', ['active', 'inactive', 'terminated'], false,
                        'Status'), ['change', 'blur']],
                    ['leave_balance', () => validateNumberNonNegative('leave_balance', 'Leave balance'), [
                        'input', 'blur'
                    ]],
                    ['resume', () => validateFile('resume', ['pdf', 'doc', 'docx'], 5, 'Resume'), [
                        'change'
                    ]],
                    ['aadhar_card', () => validateFile('aadhar_card', ['pdf', 'jpg', 'jpeg', 'png'], 5,
                        'Aadhar card'), ['change']],
                    ['pan_card', () => validateFile('pan_card', ['pdf', 'jpg', 'jpeg', 'png'], 5,
                        'PAN card'), ['change']],
                ];
            ...
            const setSubmittingState = (submitting) => {
                ...
                if (submitting) {
                    ...
                    if (!submitBtn.querySelector('.v0-spinner')) {
                        ...
                        spinner.className =
                            'v0-spinner ml-2 inline-block w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin';
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (validateSelectIn('employment_type', ['Full-Time', 'Part-Time', 'intern', 'trainee',
                        'contract'
                    ], false, 'Employment type')) errors.push('employment_type');
                if (validateSelectIn('status', ['active', 'inactive', 'terminated'], false, 'Status'))
                    errors.push('status');
                if (validateNumberNonNegative('leave_balance', 'Leave balance')) errors.push(
                    'leave_balance');
                if (validateFile('resume', ['pdf', 'doc', 'docx'], 5, 'Resume')) errors.push('resume');
                if (validateFile('aadhar_card', ['pdf', 'jpg', 'jpeg', 'png'], 5, 'Aadhar card')) errors
                    .push('aadhar_card');
                if (validateFile('pan_card', ['pdf', 'jpg', 'jpeg', 'png'], 5, 'PAN card')) errors.push(
                    'pan_card');
