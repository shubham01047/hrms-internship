            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-200">
                <div class="theme-app px-6 py-4 border-b border-gray-200" style="background: linear-gradient(to right, var(--secondary-bg), var(--primary-bg));">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold" style="color: var(--primary-text);">Update User Information</h3>
                            <p class="text-sm" style="color: var(--secondary-text);">Modify user details and role assignments</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('users.update', $users->id) }}" method="POST" class="space-y-8">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                            <div class="space-y-4">
                                <div class="flex items-center space-x-2 mb-4">
                                    ...
                                    <h4 class="theme-app text-lg font-semibold" style="color: var(--primary-text);">User Information</h4>
                                </div>
                        ...
                        <div class="bg-blue-50 rounded-lg p-6 border border-blue-200">
                            <div class="flex items-center space-x-2 mb-6">
                                ...
                                <h4 class="theme-app text-lg font-semibold" style="color: var(--primary-text);">Role Assignment</h4>
                            </div>
                            
                            @if ($roles->isNotEmpty())
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    @foreach ($roles as $role)
                                        <div class="bg-white rounded-lg p-4 border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-300 ease-in-out transform hover:scale-105 {{ $hasRoles->contains($role->id) ? 'ring-2 ring-blue-200 bg-blue-50' : '' }}">
