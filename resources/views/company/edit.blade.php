<x-app-layout>
    ...
    <div class="py-8" style="background-color: #f8fafc; min-height: 100vh;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session('success'))
                <div class="px-4 py-3 rounded-lg mb-6 backdrop-blur-sm" style="background-color: rgba(34, 197, 94, 0.2); border: 1px solid rgba(34, 197, 94, 0.3); color: var(--primary-text, #f8fafc);">
            ...
            @endif
            @if (session('error'))
                <div class="px-4 py-3 rounded-lg mb-6 backdrop-blur-sm" style="background-color: rgba(239, 68, 68, 0.2); border: 1px solid rgba(239, 68, 68, 0.3); color: var(--primary-text, #f8fafc);">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form action="{{ route('company.update', $company->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-xl border border-gray-200">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 rounded-t-xl"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h2 class="text-lg font-semibold" style="color: var(--primary-text);">Company Information</h2>
                        </div>
                    </div>
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="system_title" value="{{ old('system_title', $company->system_title) }}" 
                        ...
                        <div>
                            ...
                            @if ($company->company_logo)
                                <div class="mb-4">
                                    ...
                                    <div class="bg-gray-100 p-4 rounded-lg inline-block border border-gray-200">
                                        <img src="{{ asset('images/' . $company->company_logo) }}" alt="Company Logo" class="max-h-24 rounded">
                                    </div>
                                </div>
                            @endif
                ...
                <div class="bg-white rounded-xl shadow-xl border border-blue-200">
                    ...
                    <div class="px-6 py-4 border-b border-blue-200 rounded-t-xl"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h2 class="text-lg font-semibold" style="color: var(--primary-text);">Theme Customization</h2>
                        </div>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="color" name="navbar_color" value="{{ old('navbar_color', $company->navbar_color ?? '#000000') }}" 
                                        class="w-12 h-12 rounded-lg border-2 border-gray-300 bg-transparent cursor-pointer">
                                    <input type="text" value="{{ old('navbar_color', $company->navbar_color ?? '#000000') }}" readonly 
                            ...
                            <div>
                                <label class="block text-gray-700 font-medium mb-2">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
                                    </svg>
                                    Sidebar Color
                                </label>
                                <div class="flex items-center gap-3">
                                    <input type="color" name="sidebar_color" value="{{ old('sidebar_color', $company->sidebar_color ?? '#000000') }}" 
                                        class="w-12 h-12 rounded-lg border-2 border-gray-300 bg-transparent cursor-pointer">
                                    <input type="text" value="{{ old('sidebar_color', $company->sidebar_color ?? '#000000') }}" readonly 
                                        class="flex-1 px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-700 text-sm">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="color" name="primary_color" value="{{ old('primary_color', $company->primary_color ?? '#000000') }}" 
                                        class="w-12 h-12 rounded-lg border-2 border-gray-300 bg-transparent cursor-pointer">
                                    <input type="text" value="{{ old('primary_color', $company->primary_color ?? '#000000') }}" readonly 
                                        class="flex-1 px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-700 text-sm">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="color" name="text_color" value="{{ old('text_color', $company->text_color ?? '#000000') }}" 
                                        class="w-12 h-12 rounded-lg border-2 border-gray-300 bg-transparent cursor-pointer">
                                    <input type="text" value="{{ old('text_color', $company->text_color ?? '#000000') }}" readonly 
                                        class="flex-1 px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-700 text-sm">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="color" name="footer_color" value="{{ old('footer_color', $company->footer_color ?? '#000000') }}" 
                                        class="w-12 h-12 rounded-lg border-2 border-gray-300 bg-transparent cursor-pointer">
                                    <input type="text" value="{{ old('footer_color', $company->footer_color ?? '#000000') }}" readonly 
                                        class="flex-1 px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-700 text-sm">
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-xl border border-green-200">
                    ...
                    <div class="p-6">
                        <div class="flex flex-col sm:flex-row gap-4 sm:justify-end">
                            <a href="{{ url()->previous() }}" class="inline-flex items-center justify-center px-6 py-3 font-semibold rounded-lg shadow-lg transform transition-all duration-300 focus:outline-none focus:ring-4"
                            ...
                            <button type="submit" class="inline-flex items-center justify-center px-6 py-3 font-semibold rounded-lg shadow-lg transform transition-all duration-300 focus:outline-none focus:ring-4"
