            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-200">
                <div class="bg-gradient-to-r from-green-50 to-green-100 px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Role Configuration</h3>
                            <p class="text-sm text-gray-600">Define the role name and assign permissions</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('roles.store') }}" method="POST" class="space-y-8">
                        ...
                        <div class="bg-blue-50 rounded-lg p-6 border border-blue-200">
                            <div class="flex items-center space-x-2 mb-6">
                                ...
                                <h4 class="text-lg font-semibold text-gray-900">Assign Permissions</h4>
                            </div>
