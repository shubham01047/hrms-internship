...
<div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
    <div class="p-6 text-black">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 gap-4 sm:gap-6">
                ...
                <div class="bg-secondary-gradient text-primary p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg animate-fade-in relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="text-center mb-6 sm:mb-8">
                            ...
                            <p class="text-base sm:text-lg lg:text-xl opacity-90">Manager Dashboard - Monitor your team's progress</p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-100">
                    <div class="bg-primary p-3 sm:p-4 rounded-t-xl mb-4">
                        <h2 class="text-lg sm:text-xl font-semibold text-primary">Team Performance Summary</h2>
                    </div>
                    <div class="max-h-60 overflow-y-auto space-y-3 pr-2">
                        <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <i class="bi bi-trophy-fill text-yellow-500 text-xl flex-shrink-0 mt-1"></i>
                            <div>
                                <p class="font-semibold text-gray-800 text-sm sm:text-base">Development Team A completed Mobile App Update ahead of schedule.</p>
                        ...
                        <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            ...
                            <div>
                                <p class="font-semibold text-gray-800 text-sm sm:text-base">Design Team delivered Website Redesign mockups for review.</p>
                                <p class="text-xs text-gray-500 mt-1">4 hours ago</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <i class="bi bi-exclamation-triangle-fill text-orange-500 text-xl flex-shrink-0 mt-1"></i>
                            <div>
                                <p class="font-semibold text-gray-800 text-sm sm:text-base">Payment Gateway integration requires additional resources.</p>
                                <p class="text-xs text-gray-500 mt-1">Yesterday</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <i class="bi bi-people-fill text-blue-500 text-xl flex-shrink-0 mt-1"></i>
                            <div>
                                <p class="font-semibold text-gray-800 text-sm sm:text-base">Backend Team started Database Migration planning phase.</p>
                ...
                <div class="overflow-x-auto pb-4 animate-fade-in animate-delay-300">
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6 min-w-[600px] lg:min-w-0">
                        <div class="p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-[1.01]
                            ...
                            <h3 class="text-xs sm:text-sm text-gray-500">Team Members</h3>
                        ...
                        <div class="p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-[1.01]
                            ...
                            <p class="text-2xl sm:text-3xl font-bold">5</p>
                        </div>
                        <div class="p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-[1.01]
                            bg-white text-purple-600 border-primary border
                            flex flex-col items-start gap-2 sm:gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-7 sm:w-7 text-purple-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                            <h3 class="text-xs sm:text-sm text-gray-500">Completed Tasks</h3>
                            <p class="text-2xl sm:text-3xl font-bold">18</p>
                        </div>
                        <div class="p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-[1.01]
                            bg-white text-yellow-500 border-primary border
                            flex flex-col items-start gap-2 sm:gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-7 sm:w-7 text-yellow-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <h3 class="text-xs sm:text-sm text-gray-500">Pending Reviews</h3>
                            <p class="text-2xl sm:text-3xl font-bold">7</p>
                        </div>
                        <div class="p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out hover:scale-[1.01]
                            bg-white text-pink-600 border-primary border
                            flex flex-col items-start gap-2 sm:gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-7 sm:w-7 text-pink-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/></svg>
                            <h3 class="text-xs sm:text-sm text-gray-500">Reports Due</h3>
                            <p class="text-2xl sm:text-3xl font-bold">3</p>
                        </div>
                    </div>
                </div>

                <!-- Team Status and Manager Actions Wrapper -->
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 animate-fade-in animate-delay-400">
                    ...
                    <div class="bg-white p-4 sm:p-6 rounded-xl shadow-lg border-primary border">
                        <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Team Status</h2>
                        <ul class="space-y-3">
                            <li class="flex items-center gap-3 text-gray-700">
                                ...
                                <span class="text-sm sm:text-base">Development Team A - On Track</span>
                            </li>
                            <li class="flex items-center gap-3 text-gray-700">
                                ...
                                <span class="text-sm sm:text-base">Integration Team - Needs Support</span>
                            </li>
                            <li class="flex items-center gap-3 text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 text-green-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                <span class="text-sm sm:text-base">Design Team - Ahead of Schedule</span>
                            </li>
                            <li class="flex items-center gap-3 text-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" style="color: var(--primary-bg);" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                <span class="text-sm sm:text-base">Backend Team - In Planning Phase</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white p-4 sm:p-6 rounded-xl shadow-lg border-primary border animate-fade-in animate-delay-500">
                        <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-4">Manager Actions</h2>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <a href="#" class="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl text-primary text-center
                                ...
                                <span class="font-semibold text-sm sm:text-base">Assign Resources</span>
                            </a>
                            <a href="#" class="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl text-primary text-center
                                              bg-secondary-gradient shadow-md
                                              hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-8 sm:w-8 mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                <span class="font-semibold text-sm sm:text-base">Review Progress</span>
                            </a>
                            <a href="#" class="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl text-primary text-center
                                              bg-secondary-gradient shadow-md
                                              hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-8 sm:w-8 mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><path d="M21 13V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8"/><path d="M3 10h18"/></svg>
                                <span class="font-semibold text-sm sm:text-base">Schedule Meeting</span>
                            </a>
                            <a href="#" class="flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl text-primary text-center
                                              bg-secondary-gradient shadow-md
                                              hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                ...
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-600">
                    <div class="gantt-container">
                        ...
                        <div class="gantt-header">
                            <div>
                                <h2 class="text-lg sm:text-xl font-semibold text-gray-800">Team Project Timeline</h2>
                                <p class="text-sm text-gray-600">Monitor team progress and project deadlines</p>
                            </div>
                        ...
                        <div class="p-4 bg-gray-50 border-b border-gray-200">
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                ...
                                <div class="text-center">
                                    <div class="text-lg font-bold" style="color: var(--primary-bg);">2</div>
                            ...
                            <div class="gantt-task-list">
                                ...
                                <div class="gantt-task-item" data-task="1">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="text-sm font-medium text-gray-800 truncate">Mobile App Update</div>
                                        <div class="text-xs text-gray-500">Development Team A</div>
                                    </div>
                                </div>
                                <div class="gantt-task-item" data-task="2">
                                    <div class="status-dot completed"></div>
                                    <div class="flex-1 min-w-0">
                                        <div class="text-sm font-medium text-gray-800 truncate">Website Redesign</div>
                                        <div class="text-xs text-gray-500">Design Team</div>
                                    </div>
                                </div>
                                <div class="gantt-task-item" data-task="3">
                                    <div class="status-dot planning"></div>
                                    <div class="flex-1 min-w-0">
                                        <div class="text-sm font-medium text-gray-800 truncate">Database Migration</div>
                                        <div class="text-xs text-gray-500">Backend Team</div>
                                    </div>
                                </div>
                                <div class="gantt-task-item" data-task="4">
                                    <div class="status-dot in-progress"></div>
                                    <div class="flex-1 min-w-0">
                                        <div class="text-sm font-medium text-gray-800 truncate">Customer Portal</div>
                                        <div class="text-xs text-gray-500">Full Stack Team</div>
                                    </div>
                                </div>
                                <div class="gantt-task-item" data-task="5">
                                    <div class="status-dot on-hold"></div>
                                    <div class="flex-1 min-w-0">
                                        <div class="text-sm font-medium text-gray-800 truncate">Payment Gateway</div>
                                        <div class="text-xs text-gray-500">Integration Team</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="text-sm text-gray-600">
                                        <span class="font-medium">Team:</span> <span id="detail-assignee"></span>
                                    </div>
                                    <div class="text-sm text-gray-600">
                ...
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-700">
                    <div class="bg-primary p-3 sm:p-4 rounded-t-xl mb-4">
                        <h2 class="text-lg sm:text-xl font-semibold text-primary">Team Attendance Overview</h2>
                    </div>
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                        <div class="p-3 sm:p-4 bg-blue-100 rounded-lg text-center hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <h3 class="text-gray-700 text-xs sm:text-sm">Present Today</h3>
                            <p class="text-xl sm:text-2xl font-bold" style="color: var(--primary-bg);">22</p>
                        </div>
                        <div class="p-3 sm:p-4 bg-yellow-100 rounded-lg text-center hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <h3 class="text-gray-700 text-xs sm:text-sm">Late Arrivals</h3>
                        ...
                        <div class="p-3 sm:p-4 bg-red-100 rounded-lg text-center hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            ...
                            <p class="text-xl sm:text-2xl font-bold text-red-500">0</p>
                        </div>
                        <div class="p-3 sm:p-4 bg-green-100 rounded-lg text-center hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <h3 class="text-gray-700 text-xs sm:text-sm">Team Efficiency</h3>
                            <p class="text-xl sm:text-2xl font-bold text-green-600">96%</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-800">
                    <div class="bg-primary p-3 sm:p-4 rounded-t-xl mb-4">
                        <h2 class="text-lg sm:text-xl font-semibold text-primary">Resource Allocation</h2>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                        <div class="p-3 sm:p-4 bg-blue-100 rounded-lg text-center flex flex-col items-center gap-2 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-7 sm:w-7" style="color: var(--primary-bg);" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                            <h3 class="text-gray-700 text-sm sm:text-lg font-semibold">Available Developers</h3>
                            <p class="text-2xl sm:text-4xl font-extrabold" style="color: var(--primary-bg);">8</p>
                        </div>
                        <div class="p-3 sm:p-4 bg-green-100 rounded-lg text-center flex flex-col items-center gap-2 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            ...
                            <h3 class="text-gray-700 text-sm sm:text-lg font-semibold">Assigned to Projects</h3>
                            <p class="text-2xl sm:text-4xl font-extrabold text-green-600">16</p>
                        </div>
                        <div class="p-3 sm:p-4 bg-purple-100 rounded-lg text-center flex flex-col items-center gap-2 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-7 sm:w-7 text-purple-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            <h3 class="text-gray-700 text-sm sm:text-lg font-semibold">Utilization Rate</h3>
                            <p class="text-2xl sm:text-4xl font-extrabold text-purple-600">85%</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-900 text-center">
                    <h2 class="text-lg sm:text-xl font-semibold text-gray-800 mb-4">Team Member of the Month</h2>
                    <div class="flex flex-col items-center justify-center gap-3">
                        <img src="/placeholder.svg?height=80&width=80" alt="Team Member" class="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover border-4 border-green-400 shadow-md">
                        <p class="text-xl sm:text-2xl font-bold text-green-600">Sarah Johnson</p>
                        <p class="text-base sm:text-lg text-gray-700">Team Contribution Score: <span class="font-bold">94%</span></p>
                    </div>
                </div>

                <!-- Upcoming Team Deadlines Section -->
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-1000">
                    <div class="bg-primary p-3 sm:p-4 rounded-t-xl mb-4">
                        <h2 class="text-lg sm:text-xl font-semibold text-primary">Upcoming Team Deadlines</h2>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div class="p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-100 flex items-center gap-3 sm:gap-4 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-800 text-sm sm:text-base">Mobile App Update Release</h3>
                                <p class="text-xs sm:text-sm text-gray-600">Deadline: August 20, 2025</p>
                            </div>
                        </div>
                        <div class="p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-100 flex items-center gap-3 sm:gap-4 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <i class="bi bi-calendar-x-fill text-orange-500 text-2xl sm:text-3xl"></i>
                            <div>
                                <h3 class="font-semibold text-gray-800 text-sm sm:text-base">Customer Portal Beta</h3>
                                <p class="text-xs sm:text-sm text-gray-600">Deadline: October 1, 2025</p>
                            </div>
                        </div>
                        <div class="p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-100 flex items-center gap-3 sm:gap-4 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <i class="bi bi-calendar-x-fill text-yellow-500 text-2xl sm:text-3xl"></i>
                            <div>
                                <h3 class="font-semibold text-gray-800 text-sm sm:text-base">Database Migration Planning</h3>
                                <p class="text-xs sm:text-sm text-gray-600">Deadline: September 5, 2025</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-1100">
                    <div class="bg-primary p-3 sm:p-4 rounded-t-xl mb-4">
                        <h2 class="text-lg sm:text-xl font-semibold text-primary">Team Communication</h2>
                    </div>
                    <div class="max-h-60 overflow-y-auto space-y-3 sm:space-y-4 pr-2">
                        <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <h3 class="font-semibold text-gray-800 text-sm sm:text-base">Weekly Team Standup</h3>
                            <p class="text-xs sm:text-sm text-gray-600 mt-1">Scheduled for every Monday at 9:00 AM. Discuss project progress and blockers.</p>
                            <p class="text-xs text-gray-500 mt-2">Next: August 4, 2025</p>
                        </div>
                        <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <h3 class="font-semibold text-gray-800 text-sm sm:text-base">Sprint Planning Session</h3>
                            <p class="text-xs sm:text-sm text-gray-600 mt-1">Plan upcoming sprint goals and assign tasks to team members.</p>
                            <p class="text-xs text-gray-500 mt-2">Next: August 7, 2025</p>
                        </div>
                        <div class="p-3 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-200 hover:scale-[1.01]">
                            <h3 class="font-semibold text-gray-800 text-sm sm:text-base">Code Review Session</h3>
                            <p class="text-xs sm:text-sm text-gray-600 mt-1">Review recent code submissions and provide feedback to team members.</p>
                            <p class="text-xs text-gray-500 mt-2">Next: August 6, 2025</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-1200">
                    <div class="bg-primary p-3 sm:p-4 rounded-t-xl mb-4">
                        <h2 class="text-lg sm:text-xl font-semibold text-primary">Manager Tools</h2>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <button class="flex items-center justify-center p-3 sm:p-4 rounded-lg bg-secondary-gradient text-primary font-semibold shadow-md hover:bg-hover transition-all duration-200 hover:scale-105">
                            ...
                            <span class="text-sm sm:text-base">Team Performance Report</span>
                        </button>
                        <button class="flex items-center justify-center p-3 sm:p-4 rounded-lg bg-secondary-gradient text-primary font-semibold shadow-md hover:bg-hover transition-all duration-200 hover:scale-105">
                            <i class="bi bi-calendar-week text-xl sm:text-2xl mr-2"></i>
                            <span class="text-sm sm:text-base">Schedule Team Meeting</span>
                        </button>
                        <button class="flex items-center justify-center p-3 sm:p-4 rounded-lg bg-secondary-gradient text-primary font-semibold shadow-md hover:bg-hover transition-all duration-200 hover:scale-105">
                            <i class="bi bi-person-plus text-xl sm:text-2xl mr-2"></i>
                            <span class="text-sm sm:text-base">Resource Allocation</span>
                        </button>
                        <button class="flex items-center justify-center p-3 sm:p-4 rounded-lg bg-secondary-gradient text-primary font-semibold shadow-md hover:bg-hover transition-all duration-200 hover:scale-105">
                            <i class="bi bi-clipboard-data text-xl sm:text-2xl mr-2"></i>
                            <span class="text-sm sm:text-base">Export Team Data</span>
                        </button>
                    </div>
                </div>

                <!-- Motivational Quote Section -->
                <div class="bg-gradient-to-br from-white to-blue-50 rounded-xl shadow p-4 sm:p-6 border-primary border animate-fade-in animate-delay-1300 hover:shadow-xl transition-all duration-200 hover:scale-[1.01]">
        ...
        <script>
            // Sample project data for manager view
            const managerProjects = [
                {
                    id: 1,
                    name: 'Mobile App Update',
                    assignee: 'Development Team A',
                    status: 'in-progress',
                    progress: 65,
            ...
            document.querySelectorAll('.gantt-task-item').forEach(item => {
                item.addEventListener('click', () => {
                    ...
                    const project = managerProjects.find(p => p.id === taskId);
                    if (project) {
                        selectTask(project);
                    }
                });
