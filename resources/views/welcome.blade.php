...
<body class="antialiased font-['Poppins'] theme-app">
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="absolute inset-0"
            style="background: linear-gradient(135deg, var(--primary-bg), var(--secondary-bg));"></div>
        ...
        <main class="relative z-10 flex flex-col items-center justify-center px-4 lg:px-6 py-12">
            ...
            <div id="features" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    class="bg-white/20 rounded-2xl p-6 shadow-lg hover:scale-105 transition-all duration-300 border border-white/30">
                    ...
                    <p class="text-sm" style="color: var(--secondary-text);">Enterprise-grade security with reliable
                        performance for your business operations.</p>
                </div>
                <div
                    class="bg-white/20 rounded-2xl p-6 shadow-lg hover:scale-105 transition-all duration-300 border border-white/30">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center mb-4"
                    ...
                    <p class="text-sm" style="color: var(--secondary-text);">Intuitive interface designed for seamless
                ...
                <div
                    ...
                    <p class="text-sm" style="color: var(--secondary-text);">Comprehensive reporting and analytics to
                        drive informed business decisions.</p>
                </div>
            </div>
        </main>
        ...
        <footer class="relative z-10 w-full py-4 px-4 lg:px-6 mt-12">
            <div class="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center">
                <span class="text-sm" style="color: var(--secondary-text);">&copy; {{ date('Y') }}
                    {{ $company->name }}. All rights reserved.</span>
                <div class="flex items-center space-x-6">
                    <a href="#" style="color: var(--secondary-text);"
                        class="hover:scale-110 transition-all duration-300"><i class="fab fa-twitter text-lg"></i></a>
                    <a href="#" style="color: var(--secondary-text);"
                        class="hover:scale-110 transition-all duration-300"><i
