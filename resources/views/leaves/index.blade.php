                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    @if (!$leaves->isEmpty())
                        <div class="overflow-x-auto">
                            ...
                            <div class="bg-gradient-to-r from-gray-800 to-gray-900 text-white">
                                <div
                                    class="grid grid-cols-4 gap-4 px-6 py-4 text-xs font-semibold uppercase tracking-wider">
                            ...
                            <div class="bg-white divide-y divide-gray-200">
                                @foreach ($leaves as $index => $leave)
                                    <div
                                        class="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 transition-colors duration-150 {{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-25' }}">
                                        <!-- Leave Type -->
                    ...
                    @else
                        ...
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-500 mb-6 max-w-sm mx-auto">You haven't submitted any leave applications
                                yet. Get started by applying for your first leave.</p>
                            <a href="{{ route('leaves.create') }}"
