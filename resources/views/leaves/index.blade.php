<x-app-layout>
    @can('view all leaves')
        <div class="theme-app flex flex-col sm:flex-row justify-between items-center p-4 sm:p-6 rounded-lg shadow-sm"
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0 w-full lg:mr-24">
                <div class="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-0">
                    ...
                    <div>
                        <h1 class="font-bold text-xl sm:text-xl lg:text-2xl leading-tight"
        ...
        @if (session('success'))
            <div
                class="mx-4 mt-4 sm:mx-6 sm:mt-6 bg-green-50 border-l-4 border-green-400 p-3 sm:p-4 rounded-r-lg shadow-sm">
        ...
        <div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 sm:p-6">
            <div class="max-w-7xl mx-auto">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-xs sm:text-sm font-medium text-gray-600 uppercase tracking-wide">Total
                                    Applications</p>
                                <p class="text-2xl sm:text-3xl font-bold text-gray-900 mt-1 sm:mt-2">{{ $leaves->count() }}
                                </p>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden">
                    <div class="theme-app px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-200"
                        style="background: linear-gradient(to right, var(--secondary-bg), var(--primary-bg));">
                        <div class="flex items-center justify-between">
                            <div>
                                <h2 class="text-lg sm:text-xl font-bold" style="color: var(--primary-text);">Leave
                                    Applications History</h2>
                                <p class="text-xs sm:text-sm mt-0.5 sm:mt-1" style="color: var(--secondary-text);">Total:
                                    {{ $leaves->count() }} applications</p>
                            </div>
                    ...
                    @else
                        <div class="text-center py-8 sm:py-16 px-4">
                            ...
                            <h3 class="text-lg sm:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">No Leave Applications
                            </h3>
                            <p class="text-sm sm:text-base text-gray-500 mb-4 sm:mb-6 max-w-sm mx-auto">You haven't
                                submitted any leave applications yet. Get started by applying for your first leave.</p>
                            <a href="{{ route('leaves.create') }}"
