                ...
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 lg:mr-24">
                    <div class="flex items-center space-x-3 sm:space-x-4 text-center sm:text-left">
                        <div class="p-2 sm:p-3 rounded-lg sm:rounded-2xl shadow-lg"
                            ...
                            <svg class="w-6 h-6 sm:w-8 sm:h-8" style="color: var(--primary-text);" fill="none"
            ...
            <div class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 mb-4 sm:mb-6 p-4 sm:p-6">
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-between">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                        ...
                        <div
                            class="flex items-center space-x-2 text-gray-600 bg-gray-100 px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm w-full sm:w-auto justify-center">
                    ...
                    <table class="min-w-full">
                        <thead class="theme-app"
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-3 sm:px-8 sm:py-6 text-right text-xs sm:text-sm font-bold uppercase tracking-wider"
                                    style="color: var(--primary-text);">
                                ...
                                <th class="px-4 py-3 sm:px-8 sm:py-6 text-center text-xs sm:text-sm font-bold uppercase tracking-wider"
                                    style="color: var(--primary-text);">
                                    ...
                                    <tr class="salary-row hover:bg-gray-50 transition-all duration-200 ease-in-out"
                                        ...
                                        <td class="px-4 py-3 sm:px-8 sm:py-6">
                                            <div class="flex items-center space-x-2 sm:space-x-4">
                                                ...
                                                <div>
                                                    <div
                                                        class="text-sm sm:text-base font-semibold text-gray-900 employee-name">
                                                        {{ $s->user->name }}
                                                    </div>
                                                    <div
                                        ...
                                        <td class="px-4 py-3 sm:px-8 sm:py-6">
                                            <div class="flex flex-wrap gap-1.5 sm:gap-2 justify-center">
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 sm:px-3 sm:py-1 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                                    Tax {{ $s->tax }}%
                                                </span>
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 sm:px-3 sm:py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    PF {{ $s->pf }}%
                                                </span>
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 sm:px-3 sm:py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    ESI {{ $s->esi }}%
                                                </span>
                                            </div>
                                        </td>
                                ...
                                <tr id="emptyStateRow">
                                    <td colspan="5" class="px-4 py-8 sm:px-8 sm:py-16 text-center">
                                        <div class="flex flex-col items-center justify-center space-y-4">
                                            ...
                                            <div class="text-lg font-medium text-gray-900">No salary structures found
                                            </div>
                                            <div class="text-sm text-gray-500">Get started by creating your first
                                                salary structure.</div>
                                            <a href="{{ route('salary.create') }}"
