<x-app-layout>
    <style>
        ...
        :root {
            ...
            --punch-in-bg: #e6ffe6;
            /* Light green */
            --punch-in-border: #a3e6a3;
            /* Medium green */
            --punch-in-text: #1a7a1a;
            /* Dark green */
            ...
            --punch-out-bg: #ffe6e6;
            /* Light red */
            --punch-out-border: #e6a3a3;
            /* Medium red */
            --punch-out-text: #a71a1a;
            /* Dark red */
            --punch-out-icon: #dc3545;
            /* Bootstrap danger red */

            /* Total Hours / Blue */
            --total-hours-bg: #e6f2ff;
            /* Light blue */
            --total-hours-border: #a3cce6;
            /* Medium blue */
            --total-hours-text: #1a4a7a;
            /* Dark blue */
            --total-hours-icon: #007bff;
            /* Bootstrap primary blue */

            /* Punch In Again / Yellow */
            --punch-in-again-bg: #fffbe6;
            /* Light yellow */
            --punch-in-again-border: #e6d9a3;
            /* Medium yellow */
            --punch-in-again-text: #7a6a1a;
            /* Dark yellow */
            --punch-in-again-icon: #ffc107;
            /* Bootstrap warning yellow */

            /* Punch Out Again / Purple */
            --punch-out-again-bg: #f2e6ff;
            /* Light purple */
            --punch-out-again-border: #cca3e6;
            /* Medium purple */
            --punch-out-again-text: #4a1a7a;
            /* Dark purple */
            --punch-out-again-icon: #6f42c1;
            /* Bootstrap purple */

            /* Break Details Section */
            --break-section-bg: #f8f8f8;
            /* Light gray for break section background */
            --break-section-border: #e0e0e0;
            /* Light gray border */
            --break-section-text: #333333;
            /* Dark text */
            --break-section-icon: #666666;
            /* Medium gray icon */

            /* Break Cards */
            --break-card-morning-tea-bg: #fffbe6;
            /* Yellow */
            --break-card-morning-tea-border: #e6d9a3;
            --break-card-morning-tea-text: #7a6a1a;

            --break-card-lunch-bg: #e6ffe6;
            /* Green */
            --break-card-lunch-border: #a3e6a3;
            --break-card-lunch-text: #1a7a1a;

            --break-card-evening-tea-bg: #f2e6ff;
            /* Purple */
            --break-card-evening-tea-border: #cca3e6;
            --break-card-evening-tea-text: #4a1a7a;

            --break-card-custom-bg: #e6f2ff;
            /* Light Blue */
        ...
        .avatar-circle {
            ...
            height: 48px;
            border-radius: 50%;
            background: linear-gradient(135deg, #6a5acd, #4a469f);
    ...
    @can('attendance report')
        <x-slot name="header">
            ...
            <div
                class="bg-gradient-to-r from-[var(--header-bg-from)] to-[var(--header-bg-to)] rounded-lg shadow-lg p-6 mb-6 animate-fade-in">
                ...
                <div class="attendance-card p-6 animate-fade-in animate-delay-100">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Showing Attendance From:</h3>
                                    <strong>{{ \Carbon\Carbon::parse($fromDate)->format('M j, Y') }}</strong>
                                    to <strong>{{ \Carbon\Carbon::parse($toDate)->format('M j, Y') }}</strong>
                            </div>
                        </div>
                ...
                @forelse ($attendances as $index => $attendance)
                    <div class="attendance-card animate-fade-in animate-delay-200">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                            {{ $attendance['name'] }}</h3>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Employee ID:
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <!-- Punch In -->
                            <div
                                class="grid-item bg-[var(--punch-in-bg)] border-[var(--punch-in-border)] animate-fade-in animate-delay-300">
                                <div class="flex items-center space-x-3 mb-2">
                                    <div class="bg-[var(--punch-in-icon)]/10 p-2 rounded-lg">
                                        <svg class="w-5 h-5 text-[var(--punch-in-icon)]" fill="none"
                                ...
                                <p class="text-2xl font-bold text-[var(--punch-in-text)]">
                                    {{ \Carbon\Carbon::parse($attendance['punch_in'])->format('h:i A') }}</p>
                                <p class="text-xs text-[var(--punch-in-text)] opacity-80 mt-1">Remark:
                                    {{ $attendance['punch_in_remarks'] ?? '-' }}</p>
                            </div>

                            <!-- Punch Out -->
                            <div
                                class="grid-item bg-[var(--punch-out-bg)] border-[var(--punch-out-border)] animate-fade-in animate-delay-400">
                                <div class="flex items-center space-x-3 mb-2">
                                    <div class="bg-[var(--punch-out-icon)]/10 p-2 rounded-lg">
                                        <svg class="w-5 h-5 text-[var(--punch-out-icon)]" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1">
                                            </path>
                                ...
                                <p class="text-2xl font-bold text-[var(--punch-out-text)]">
                                    {{ $attendance['punch_out'] ? \Carbon\Carbon::parse($attendance['punch_out'])->format('h:i A') : 'Not punched out' }}
                                </p>
                                <p class="text-xs text-[var(--punch-out-text)] opacity-80 mt-1">Remark:
                                    {{ $attendance['punch_out_remarks'] ?? '-' }}</p>
                            </div>

                            <!-- Total Hours -->
                            <div
                                class="grid-item bg-[var(--total-hours-bg)] border-[var(--total-hours-border)] animate-fade-in animate-delay-500">
                                <div class="flex items-center space-x-3 mb-2">
                                    <div class="bg-[var(--total-hours-icon)]/10 p-2 rounded-lg">
                                        <svg class="w-5 h-5 text-[var(--total-hours-icon)]" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-2xl font-bold text-[var(--total-hours-text)]">
                                    {{ $attendance['total_working_hours'] }}</p>
                                <p class="text-xs text-[var(--total-hours-text)] opacity-80 mt-1">Daily total work duration
                                </p>
                            </div>

                            <!-- Punch In Again -->
                            <div
                                class="grid-item bg-[var(--punch-in-again-bg)] border-[var(--punch-in-again-border)] animate-fade-in animate-delay-600">
                                <div class="flex items-center space-x-3 mb-2">
                                    <div class="bg-[var(--punch-in-again-icon)]/10 p-2 rounded-lg">
                                        <svg class="w-5 h-5 text-[var(--punch-in-again-icon)]" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-2xl font-bold text-[var(--punch-in-again-text)]">
                                    {{ $attendance['punch_in_again'] ? \Carbon\Carbon::parse($attendance['punch_in_again'])->format('h:i A') : 'Not punched in again' }}
                                </p>
                                <p class="text-xs text-[var(--punch-in-again-text)] opacity-80 mt-1">Remark:
                                    {{ $attendance['punch_in_again_remarks'] ?? '-' }}</p>
                            </div>

                            <!-- Punch Out Again -->
                            <div
                                class="grid-item bg-[var(--punch-out-again-bg)] border-[var(--punch-out-again-border)] animate-fade-in animate-delay-700">
                                <div class="flex items-center space-x-3 mb-2">
                                    <div class="bg-[var(--punch-out-again-icon)]/10 p-2 rounded-lg">
                                        <svg class="w-5 h-5 text-[var(--punch-out-again-icon)]" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-2xl font-bold text-[var(--punch-out-again-text)]">
                                    {{ $attendance['punch_out_again'] ? \Carbon\Carbon::parse($attendance['punch_out_again'])->format('h:i A') : 'Not punched out again' }}
                                </p>
                                <p class="text-xs text-[var(--punch-out-again-text)] opacity-80 mt-1">Remark:
                                    {{ $attendance['punch_out_again_remarks'] ?? '-' }}</p>
                            </div>

                            <!-- Total Overtime Hours -->
                            <div
                                class="grid-item bg-[var(--total-hours-bg)] border-[var(--total-hours-border)] animate-fade-in animate-delay-800">
                                <div class="flex items-center space-x-3 mb-2">
                                    <div class="bg-[var(--total-hours-icon)]/10 p-2 rounded-lg">
                                        <svg class="w-5 h-5 text-[var(--total-hours-icon)]" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class="text-xs text-[var(--total-hours-text)] opacity-80 mt-1">Additional hours worked
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="bg-[var(--break-section-bg)] rounded-lg p-4 border-[var(--break-section-border)]">
                                <div class="flex items-center justify-between mb-4">
                                    <h4 class="text-lg font-semibold text-[var(--break-section-text)] flex items-center">
                                        <svg class="w-5 h-5 mr-2 text-[var(--break-section-icon)]" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    @if (!empty($attendance['breaks']) && count($attendance['breaks']) > 0)
                                        <span
                                            class="bg-gray-200 dark:bg-gray-700 px-3 py-1 rounded-full text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        @foreach ($attendance['breaks'] as $break)
                                            @php
                                                ...
                                                $config = [
                                                    'morning tea' => [
                                                        'bg' => 'var(--break-card-morning-tea-bg)',
                                                        'border' => 'var(--break-card-morning-tea-border)',
                                                        'text' => 'var(--break-card-morning-tea-text)',
                                                        'emoji' => '☕ Morning Tea',
                                                    ],
                                                    'lunch' => [
                                                        'bg' => 'var(--break-card-lunch-bg)',
                                                        'border' => 'var(--break-card-lunch-border)',
                                                        'text' => 'var(--break-card-lunch-text)',
                                                        'emoji' => '🍽️ Lunch',
                                                    ],
                                                    'evening tea' => [
                                                        'bg' => 'var(--break-card-evening-tea-bg)',
                                                        'border' => 'var(--break-card-evening-tea-border)',
                                                        'text' => 'var(--break-card-evening-tea-text)',
                                                        'emoji' => '🫖 Evening Tea',
                                                    ],
                                                    'custom' => [
                                                        'bg' => 'var(--break-card-custom-bg)',
                                                        'border' => 'var(--break-card-custom-border)',
                                                        'text' => 'var(--break-card-custom-text)',
                                                        'emoji' => '💼 Custom',
                                                    ],
                                                ];
                                            ...
                                            <div
                                                class="break-card bg-[{{ $currentBreakConfig['bg'] }}] border-[{{ $currentBreakConfig['border'] }}] animate-fade-in animate-delay-1000">
                                                <div class="flex items-center space-x-2">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <p
                                                        class="text-xs text-[{{ $currentBreakConfig['text'] }}] opacity-75">
                                                        Duration</p>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                @else
                                    <div class="text-center py-8">
                                        ...
                                        <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-1">No Breaks Taken
                                        </h4>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">Employee worked continuously
                                            today</p>
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-700 dark:text-green-200 mt-2">
                                            Continuous Work
                                        </span>
                                    </div>
                                @endif
