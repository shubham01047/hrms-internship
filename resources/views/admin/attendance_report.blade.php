            ...
            <div class="w-full max-w-6xl mx-auto space-y-6">
                <div class="card p-4 sm:p-6 animate-fade-in">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <div
                            class="px-4 py-1.5 rounded-full bg-primary-light border border-primary self-start md:self-auto">
                    ...
                    <form method="GET" action="{{ route('admin.attendance.report') }}"
                        ...
                        <div class="lg:col-span-3 flex items-end gap-2">
                            ...
                            <a href="{{ route('admin.report.form') }}">Download Report</a>
                        </div>
                    </form>
                </div>
                            ...
                            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-secondary text-sm">Employee ID:
                            ...
                            <div class="info-tile" style="background:#e6ffe6;border-color:#a3e6a3">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="p-2 rounded-lg" style="background:#28a7451a">
                                        <svg class="w-5 h-5" style="color:#28a745" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-2xl font-bold" style="color:#1a7a1a">
                                    {{ \Carbon\Carbon::parse($attendance['punch_in'])->format('h:i A') }}</p>
                                <p class="text-xs mt-1" style="color:#1a7a1acc">Remark:
                            ...
                            <div class="info-tile" style="background:#ffe6e6;border-color:#e6a3a3">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="p-2 rounded-lg" style="background:#dc35451a">
                                        <svg class="w-5 h-5" style="color:#dc3545" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-xs mt-1" style="color:#a71a1acc">Remark:
                            ...
                            <div class="info-tile" style="background:#e6f2ff;border-color:#a3cce6">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="p-2 rounded-lg" style="background:#007bff1a">
                                        <svg class="w-5 h-5" style="color:#007bff" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-2xl font-bold" style="color:#1a4a7a">
                            ...
                            <div class="info-tile" style="background:#fffbe6;border-color:#e6d9a3">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="p-2 rounded-lg" style="background:#ffc1071a">
                                        <svg class="w-5 h-5" style="color:#ffc107" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <p class="text-xs mt-1" style="color:#7a6a1acc">Remark:
                            ...
                            <div class="info-tile" style="background:#f2e6ff;border-color:#cca3e6">
                                <div class="flex items-center gap-3 mb-2">
                                    <div class="p-2 rounded-lg" style="background:#6f42c11a">
                                        <svg class="w-5 h-5" style="color:#6f42c1" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M17 16l4-4m0 0l-4-4m4 4H7" />
                                        </svg>
                                ...
                                <p class="text-xs mt-1" style="color:#4a1a7acc">Remark:
                            ...
                            <div class="card p-4">
                                <div class="flex items-center justify-between mb-4">
                                    <h4 class="section-title text-base sm:text-lg flex items-center gap-2">
                                        <svg class="w-5 h-5 text-[var(--primary-bg)]/70" fill="none"
                                    ...
                                    @if (!empty($attendance['breaks']) && count($attendance['breaks']) > 0)
                                        <span
                                            class="px-3 py-1 rounded-full text-sm font-medium bg-primary-light border border-primary text-primary">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                                        @foreach ($attendance['breaks'] as $break)
                                            ...
                                            <div class="break-card"
                                                style="background: {{ $current['bg'] }}; border-color: {{ $current['border'] }};">
                                                <div class="flex items-center gap-2">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <p class="text-xs"
                                                        style="color: {{ $current['text'] }}; opacity:.75">Duration</p>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                @else
                                    <div class="text-center py-8">
                                        <div
                                            class="p-3 rounded-full mx-auto mb-3 w-fit bg-primary-light border border-primary">
                                            <svg class="w-6 h-6 text-[var(--primary-bg)]/60" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        ...
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-[#f0fdf4] text-[#16a34a] border border-[#86efac] mt-2">
                                            Continuous Work
                                        </span>
                                    </div>
                                @endif
                ...
                @empty
                    <div class="text-center py-12 card animate-fade-in">
                        <div class="p-4 rounded-full mx-auto mb-4 w-fit bg-primary-light border border-primary">
                            <svg class="w-8 h-8 text-[var(--primary-bg)]/60" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2" />
                            </svg>
